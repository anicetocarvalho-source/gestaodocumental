...
import { PrintPreferencesProvider } from "@/contexts/PrintPreferencesContext";
...
import PhysicalArchiveHistory from "./pages/PhysicalArchiveHistory";
import PhysicalArchiveReports from "./pages/PhysicalArchiveReports";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/v" element={<PublicValidate />} />
              <Route path="/v/:token" element={<PublicValidate />} />
