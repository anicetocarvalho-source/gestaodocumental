...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {!collapsed && (
        <div className="p-4">
          <button className="flex w-full items-center gap-2 rounded-md border border-sidebar-border bg-sidebar-accent/30 px-3 py-2 text-sm text-sidebar-muted hover:bg-sidebar-accent/50 transition-colors">
