...
const helpCategories: HelpCategory[] = [
  {
    ...
    articles: [
      {
        id: "intro",
        title: "Introdução ao MINAGRIF",
        content: `O MINAGRIF é um sistema integrado de gestão documental desenvolvido para o Ministério da Agricultura e Pescas. O sistema permite:
...
• Esc: Fechar modais`,
      ...
      },
      {
        id: "tour",
        title: "Tour Guiado",
        content: `O MINAGRIF oferece um tour interactivo para novos utilizadores. O tour apresenta as principais funcionalidades e ajuda a familiarizar-se com a interface.
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg">
        <SheetHeader>
          ...
          <SheetDescription>
            Documentação, tutoriais e suporte do MINAGRIF
          </SheetDescription>
        </SheetHeader>
          ...
          <div className="border-t pt-4">
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" className="flex-1" asChild>
                <a href="mailto:suporte@minagrif.gov.ao">
